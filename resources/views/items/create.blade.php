        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Create Service/Item</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Service/Item Information</h3>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name">Service/Item Name <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('unit_type') is-invalid @enderror" 
                                            ...
                                            <option value="hour" {{ old('unit_type') == 'hour' ? 'selected' : '' }}>Hour</option>
                                            <option value="day" {{ old('unit_type') == 'day' ? 'selected' : '' }}>Day</option>
                                            <option value="week" {{ old('unit_type') == 'week' ? 'selected' : '' }}>Week</option>
                                            <option value="month" {{ old('unit_type') == 'month' ? 'selected' : '' }}>Month</option>
                                            <option value="project" {{ old('unit_type') == 'project' ? 'selected' : '' }}>Project</option>
                                            <option value="consultation" {{ old('unit_type') == 'consultation' ? 'selected' : '' }}>Consultation</option>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('notes') is-invalid @enderror" 
                                          ...
                                          placeholder="Any additional notes about this service">{{ old('notes') }}</textarea>
                                @error('notes')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
