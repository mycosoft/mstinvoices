...
@section('content')
    <div class="container-fluid">
        <form action="{{ route('expenses.update', $expense) }}" method="POST" id="expense-form" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('expense_number') is-invalid @enderror" 
                                               ...
                                               value="{{ old('expense_number', $expense->expense_number) }}" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('reference_number') is-invalid @enderror" 
                                               ...
                                               value="{{ old('reference_number', $expense->reference_number) }}" placeholder="Receipt/Invoice number">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('title') is-invalid @enderror" 
                                               id="title" name="title" 
                                               value="{{ old('title', $expense->title) }}" required placeholder="Enter expense title">
                                        @error('title')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('vendor_name') is-invalid @enderror" 
                                               ...
                                               value="{{ old('vendor_name', $expense->vendor_name) }}" placeholder="Vendor or supplier name">
                                        @error('vendor_name')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control @error('vendor_email') is-invalid @enderror" 
                                               ...
                                               value="{{ old('vendor_email', $expense->vendor_email) }}" placeholder="vendor@example.com">
                                        @error('vendor_email')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('vendor_phone') is-invalid @enderror" 
                                               ...
                                               value="{{ old('vendor_phone', $expense->vendor_phone) }}" placeholder="Phone number">
                                        @error('vendor_phone')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" min="0" 
                                               ...
                                               value="{{ old('net_amount', $expense->net_amount) }}" required>
                                        @error('net_amount')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" min="0" 
                                               ...
                                               value="{{ old('amount', $expense->amount) }}" required readonly>
                                        @error('amount')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('currency') is-invalid @enderror" 
                                            ...
                                            <option value="UGX" {{ old('currency', $expense->currency) == 'UGX' ? 'selected' : '' }}>UGX - Ugandan Shilling</option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('receipt_number') is-invalid @enderror" 
                                               ...
                                               value="{{ old('receipt_number', $expense->receipt_number) }}" placeholder="Receipt or transaction number">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('payment_status') is-invalid @enderror" 
                                            ...
                                            <option value="unpaid" {{ old('payment_status', $expense->payment_status) == 'unpaid' ? 'selected' : '' }}>Unpaid</option>
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox d-inline-block mr-4">
                                            <input type="checkbox" class="custom-control-input" id="is_billable" 
                                                   name="is_billable" value="1" {{ old('is_billable', $expense->is_billable) ? 'checked' : '' }}>
                                        ...
                                        <div class="custom-control custom-checkbox d-inline-block mr-4">
                                            <input type="checkbox" class="custom-control-input" id="is_reimbursable" 
                                                   name="is_reimbursable" value="1" {{ old('is_reimbursable', $expense->is_reimbursable) ? 'checked' : '' }}>
                                        ...
                                        <div class="custom-control custom-checkbox d-inline-block">
                                            <input type="checkbox" class="custom-control-input" id="is_recurring" 
                                                   name="is_recurring" value="1" {{ old('is_recurring', $expense->is_recurring) ? 'checked' : '' }}>
                            ...
                            <!-- Recurring Options -->
                            <div id="recurring-options" style="{{ $expense->is_recurring ? 'display: block;' : 'display: none;' }}">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="recurring_end_date" 
                                                   name="recurring_end_date" value="{{ old('recurring_end_date', $expense->recurring_end_date ? $expense->recurring_end_date->format('Y-m-d') : '') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('project_code') is-invalid @enderror" 
                                               ...
                                               value="{{ old('project_code', $expense->project_code) }}" placeholder="Project or job code">
                                        @error('project_code')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('department') is-invalid @enderror" 
                                               ...
                                               value="{{ old('department', $expense->department) }}" placeholder="Department or division">
                                        @error('department')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('location') is-invalid @enderror" 
                                               ...
                                               value="{{ old('location', $expense->location) }}" placeholder="Location or office">
                                        @error('location')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('notes') is-invalid @enderror" 
                                                  ...
                                                  placeholder="Internal notes and additional information">{{ old('notes', $expense->notes) }}</textarea>
                                        @error('notes')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="attachments">Upload Additional Receipts/Invoices</label>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-sm">
                                            <tr>
                                                ...
                                                <td class="text-right" id="summary-net-amount">{{ $settings->currency_symbol }} {{ number_format($expense->net_amount, 2) }}</td>
                                            </tr>
                                            <tr>
                                                <td><strong>Tax Amount:</strong></td>
                                                <td class="text-right" id="summary-tax-amount">{{ $settings->currency_symbol }} {{ number_format($expense->tax_amount, 2) }}</td>
                                            </tr>
                                            <tr class="bg-light">
                                                <td><strong>Total Amount:</strong></td>
                                                <td class="text-right" id="summary-total-amount"><strong>{{ $settings->currency_symbol }} {{ number_format($expense->amount, 2) }}</strong></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
