...
class QuotationItem extends Model
{
    ...
    /**
     * Get the item that this quotation item references.
     */
    ...
    /**
     * Create quotation item from item model.
     */
    public static function createFromItem(Quotation $quotation, Item $item, float $quantity = 1, int $sortOrder = 0): self
    {
        $quotationItem = new self([
        ...
        $quotationItem->calculateAmounts();
    ...
    protected static function boot()
    {
        ...
        static::saved(function ($quotationItem) {
